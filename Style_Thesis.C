...
// By ROOT version 5.34/20 on 2014-10-20 17:23:25
...
void Style_Thesis()
{
   ...
   TStyle *tmpStyle = new TStyle("Thesis", "Style for Bachelorthesis");
   ...
   tmpStyle->SetTitleOffset(0.8, "y");
   tmpStyle->SetTitleOffset(0.8, "z");
   ...
   tmpStyle->SetLegendFillColor(-26215);
   tmpStyle->SetLegendFont(-26215);
